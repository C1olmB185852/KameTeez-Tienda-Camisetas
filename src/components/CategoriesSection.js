    ...
    <div className="my-8 px-4 md:px-8">
      ...
      <div className="relative">
        <div className="overflow-hidden">
          ...
          >
            {categories.map((category) => (
              <div
                key={category.id}
                className="min-w-[280px] md:min-w-[320px] lg:min-w-[360px] bg-orange p-6 rounded-lg shadow-lg hover:scale-105 transition-all cursor-pointer"
        ...
        <div className="absolute top-1/2 left-0 right-0 flex justify-between transform -translate-y-1/2 px-4">
          <button
            className="bg-orange-600 text-white p-3 rounded-full shadow-md hover:bg-orange-700"
